...
var schemas = [
  ...
  'CREATE TABLE messages (' +
    ...
    'INDEX class_key_idx (class_key),' +
    'INDEX class_key_base_idx (class_key_base),' +
    'INDEX instance_key_idx (instance_key),' +
    'INDEX instance_key_base_idx (instance_key_base),' +
    'INDEX conversation_idx (conversation),' +
