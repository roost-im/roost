...
Subscriber.prototype.start = function() {
  // Before anything else, restore inner demons from state file. Just
  // to make it slightly less likely we reuse their ports or
  // something? I dunno.
  return Q.nfcall(
    ...
    Object.keys(state).forEach(function(principal) {
      this.spawnInnerDemon_(principal, state[principal]);
    }.bind(this));
